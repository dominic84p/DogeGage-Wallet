...
// NOTE: window globals kept intentionally — getTezosEd25519Keys is called as a bare
// global from multiple service files and the CDN-loaded nacl/blake2b scripts.
if (typeof window !== 'undefined') {
    window.getTezosEd25519Keys = getTezosEd25519Keys;
    window.deriveTezosSeed = deriveTezosSeed;
    window.hexToBytes = hexToBytes;
    window.bytesToHex = bytesToHex;
}

// Also export as ES modules for new code
export { getTezosEd25519Keys, deriveTezosSeed, hexToBytes, bytesToHex };
